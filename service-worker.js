...
const CACHE_NAME = 'somthingreat-v8-63-requested-fixes';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-63-requested-fixes',
  './welcome.css?v=v8-63-requested-fixes',
  './auth.css?v=v8-63-requested-fixes',
  './workout.css?v=v8-63-requested-fixes',
  './account.css?v=v8-63-requested-fixes',
  './auth.js?v=v8-63-requested-fixes',
  './workouts.js?v=v8-63-requested-fixes',
  './state.js?v=v8-63-requested-fixes',
  './account.js?v=v8-63-requested-fixes',
  './admin.js?v=v8-63-requested-fixes',
  './render.js?v=v8-63-requested-fixes',
  './app.js?v=v8-63-requested-fixes',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
