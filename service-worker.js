...
const CACHE_NAME = 'somthingreat-v8-31-ipad-consistency';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-31-ipad-consistency',
  './welcome.css?v=v8-31-ipad-consistency',
  './auth.css?v=v8-31-ipad-consistency',
  './workout.css?v=v8-31-ipad-consistency',
  './account.css?v=v8-31-ipad-consistency',
  './auth.js?v=v8-31-ipad-consistency',
  './workouts.js?v=v8-31-ipad-consistency',
  './state.js?v=v8-31-ipad-consistency',
  './account.js?v=v8-31-ipad-consistency',
  './admin.js?v=v8-31-ipad-consistency',
  './render.js?v=v8-31-ipad-consistency',
  './app.js?v=v8-31-ipad-consistency',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
