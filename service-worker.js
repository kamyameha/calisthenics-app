...
const CACHE_NAME = 'somthingreat-v8-37-workout-timers';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-37-workout-timers',
  './welcome.css?v=v8-37-workout-timers',
  './auth.css?v=v8-37-workout-timers',
  './workout.css?v=v8-37-workout-timers',
  './account.css?v=v8-37-workout-timers',
  './auth.js?v=v8-37-workout-timers',
  './workouts.js?v=v8-37-workout-timers',
  './state.js?v=v8-37-workout-timers',
  './account.js?v=v8-37-workout-timers',
  './admin.js?v=v8-37-workout-timers',
  './render.js?v=v8-37-workout-timers',
  './app.js?v=v8-37-workout-timers',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
