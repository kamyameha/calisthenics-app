...
const CACHE_NAME = 'somthingreat-v8-64-layout-polish';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-64-layout-polish',
  './welcome.css?v=v8-64-layout-polish',
  './auth.css?v=v8-64-layout-polish',
  './workout.css?v=v8-64-layout-polish',
  './account.css?v=v8-64-layout-polish',
  './auth.js?v=v8-64-layout-polish',
  './workouts.js?v=v8-64-layout-polish',
  './state.js?v=v8-64-layout-polish',
  './account.js?v=v8-64-layout-polish',
  './admin.js?v=v8-64-layout-polish',
  './render.js?v=v8-64-layout-polish',
  './app.js?v=v8-64-layout-polish',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
