...
const CACHE_NAME = 'somthingreat-v8-34-custom-checklist-polish';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-34-custom-checklist-polish',
  './welcome.css?v=v8-34-custom-checklist-polish',
  './auth.css?v=v8-34-custom-checklist-polish',
  './workout.css?v=v8-34-custom-checklist-polish',
  './account.css?v=v8-34-custom-checklist-polish',
  './auth.js?v=v8-34-custom-checklist-polish',
  './workouts.js?v=v8-34-custom-checklist-polish',
  './state.js?v=v8-34-custom-checklist-polish',
  './account.js?v=v8-34-custom-checklist-polish',
  './admin.js?v=v8-34-custom-checklist-polish',
  './render.js?v=v8-34-custom-checklist-polish',
  './app.js?v=v8-34-custom-checklist-polish',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
