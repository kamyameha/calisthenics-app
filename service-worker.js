...
const CACHE_NAME = 'somthingreat-v8-62-privacy-footer-fix';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-62-privacy-footer-fix',
  './welcome.css?v=v8-62-privacy-footer-fix',
  './auth.css?v=v8-62-privacy-footer-fix',
  './workout.css?v=v8-62-privacy-footer-fix',
  './account.css?v=v8-62-privacy-footer-fix',
  './auth.js?v=v8-62-privacy-footer-fix',
  './workouts.js?v=v8-62-privacy-footer-fix',
  './state.js?v=v8-62-privacy-footer-fix',
  './account.js?v=v8-62-privacy-footer-fix',
  './admin.js?v=v8-62-privacy-footer-fix',
  './render.js?v=v8-62-privacy-footer-fix',
  './app.js?v=v8-62-privacy-footer-fix',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
