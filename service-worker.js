...
const CACHE_NAME = 'somthingreat-v8-49-google-password-support';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-49-google-password-support',
  './welcome.css?v=v8-49-google-password-support',
  './auth.css?v=v8-49-google-password-support',
  './workout.css?v=v8-49-google-password-support',
  './account.css?v=v8-49-google-password-support',
  './auth.js?v=v8-49-google-password-support',
  './workouts.js?v=v8-49-google-password-support',
  './state.js?v=v8-49-google-password-support',
  './account.js?v=v8-49-google-password-support',
  './admin.js?v=v8-49-google-password-support',
  './render.js?v=v8-49-google-password-support',
  './app.js?v=v8-49-google-password-support',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
