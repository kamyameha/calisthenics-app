...
const CACHE_NAME = 'somthingreat-v8-35-autofill-polish';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-35-autofill-polish',
  './welcome.css?v=v8-35-autofill-polish',
  './auth.css?v=v8-35-autofill-polish',
  './workout.css?v=v8-35-autofill-polish',
  './account.css?v=v8-35-autofill-polish',
  './auth.js?v=v8-35-autofill-polish',
  './workouts.js?v=v8-35-autofill-polish',
  './state.js?v=v8-35-autofill-polish',
  './account.js?v=v8-35-autofill-polish',
  './admin.js?v=v8-35-autofill-polish',
  './render.js?v=v8-35-autofill-polish',
  './app.js?v=v8-35-autofill-polish',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
