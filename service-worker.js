...
const CACHE_NAME = 'somthingreat-v8-50-today-spacing-active-users';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-50-today-spacing-active-users',
  './welcome.css?v=v8-50-today-spacing-active-users',
  './auth.css?v=v8-50-today-spacing-active-users',
  './workout.css?v=v8-50-today-spacing-active-users',
  './account.css?v=v8-50-today-spacing-active-users',
  './auth.js?v=v8-50-today-spacing-active-users',
  './workouts.js?v=v8-50-today-spacing-active-users',
  './state.js?v=v8-50-today-spacing-active-users',
  './account.js?v=v8-50-today-spacing-active-users',
  './admin.js?v=v8-50-today-spacing-active-users',
  './render.js?v=v8-50-today-spacing-active-users',
  './app.js?v=v8-50-today-spacing-active-users',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
