...
const CACHE_NAME = 'somthingreat-v8-33-custom-checklist';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-33-custom-checklist',
  './welcome.css?v=v8-33-custom-checklist',
  './auth.css?v=v8-33-custom-checklist',
  './workout.css?v=v8-33-custom-checklist',
  './account.css?v=v8-33-custom-checklist',
  './auth.js?v=v8-33-custom-checklist',
  './workouts.js?v=v8-33-custom-checklist',
  './state.js?v=v8-33-custom-checklist',
  './account.js?v=v8-33-custom-checklist',
  './admin.js?v=v8-33-custom-checklist',
  './render.js?v=v8-33-custom-checklist',
  './app.js?v=v8-33-custom-checklist',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
