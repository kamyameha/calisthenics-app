...
const CACHE_NAME = 'somthingreat-v8-36-checklist-input-cta';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-36-checklist-input-cta',
  './welcome.css?v=v8-36-checklist-input-cta',
  './auth.css?v=v8-36-checklist-input-cta',
  './workout.css?v=v8-36-checklist-input-cta',
  './account.css?v=v8-36-checklist-input-cta',
  './auth.js?v=v8-36-checklist-input-cta',
  './workouts.js?v=v8-36-checklist-input-cta',
  './state.js?v=v8-36-checklist-input-cta',
  './account.js?v=v8-36-checklist-input-cta',
  './admin.js?v=v8-36-checklist-input-cta',
  './render.js?v=v8-36-checklist-input-cta',
  './app.js?v=v8-36-checklist-input-cta',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
