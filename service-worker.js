...
const CACHE_NAME = 'somthingreat-v8-61-privacy-page';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-61-privacy-page',
  './welcome.css?v=v8-61-privacy-page',
  './auth.css?v=v8-61-privacy-page',
  './workout.css?v=v8-61-privacy-page',
  './account.css?v=v8-61-privacy-page',
  './auth.js?v=v8-61-privacy-page',
  './workouts.js?v=v8-61-privacy-page',
  './state.js?v=v8-61-privacy-page',
  './account.js?v=v8-61-privacy-page',
  './admin.js?v=v8-61-privacy-page',
  './render.js?v=v8-61-privacy-page',
  './app.js?v=v8-61-privacy-page',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
