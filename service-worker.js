...
const CACHE_NAME = 'somthingreat-v8-55-menu-spacing-safearea';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-55-menu-spacing-safearea',
  './welcome.css?v=v8-55-menu-spacing-safearea',
  './auth.css?v=v8-55-menu-spacing-safearea',
  './workout.css?v=v8-55-menu-spacing-safearea',
  './account.css?v=v8-55-menu-spacing-safearea',
  './auth.js?v=v8-55-menu-spacing-safearea',
  './workouts.js?v=v8-55-menu-spacing-safearea',
  './state.js?v=v8-55-menu-spacing-safearea',
  './account.js?v=v8-55-menu-spacing-safearea',
  './admin.js?v=v8-55-menu-spacing-safearea',
  './render.js?v=v8-55-menu-spacing-safearea',
  './app.js?v=v8-55-menu-spacing-safearea',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
