...
const CACHE_NAME = 'somthingreat-v8-51-nav-close-spacing';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-51-nav-close-spacing',
  './welcome.css?v=v8-51-nav-close-spacing',
  './auth.css?v=v8-51-nav-close-spacing',
  './workout.css?v=v8-51-nav-close-spacing',
  './account.css?v=v8-51-nav-close-spacing',
  './auth.js?v=v8-51-nav-close-spacing',
  './workouts.js?v=v8-51-nav-close-spacing',
  './state.js?v=v8-51-nav-close-spacing',
  './account.js?v=v8-51-nav-close-spacing',
  './admin.js?v=v8-51-nav-close-spacing',
  './render.js?v=v8-51-nav-close-spacing',
  './app.js?v=v8-51-nav-close-spacing',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
