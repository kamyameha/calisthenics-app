...
const CACHE_NAME = 'somthingreat-v8-60-navbar-height-fix';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-60-navbar-height-fix',
  './welcome.css?v=v8-60-navbar-height-fix',
  './auth.css?v=v8-60-navbar-height-fix',
  './workout.css?v=v8-60-navbar-height-fix',
  './account.css?v=v8-60-navbar-height-fix',
  './auth.js?v=v8-60-navbar-height-fix',
  './workouts.js?v=v8-60-navbar-height-fix',
  './state.js?v=v8-60-navbar-height-fix',
  './account.js?v=v8-60-navbar-height-fix',
  './admin.js?v=v8-60-navbar-height-fix',
  './render.js?v=v8-60-navbar-height-fix',
  './app.js?v=v8-60-navbar-height-fix',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
