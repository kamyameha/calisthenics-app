...
const CACHE_NAME = 'somthingreat-v8-51-progress-activity-split-pull';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-51-progress-activity-split-pull',
  './welcome.css?v=v8-51-progress-activity-split-pull',
  './auth.css?v=v8-51-progress-activity-split-pull',
  './workout.css?v=v8-51-progress-activity-split-pull',
  './account.css?v=v8-51-progress-activity-split-pull',
  './auth.js?v=v8-51-progress-activity-split-pull',
  './workouts.js?v=v8-51-progress-activity-split-pull',
  './state.js?v=v8-51-progress-activity-split-pull',
  './account.js?v=v8-51-progress-activity-split-pull',
