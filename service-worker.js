...
const CACHE_NAME = 'somthingreat-v8-59-layout-regression-fix';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-59-layout-regression-fix',
  './welcome.css?v=v8-59-layout-regression-fix',
  './auth.css?v=v8-59-layout-regression-fix',
  './workout.css?v=v8-59-layout-regression-fix',
  './account.css?v=v8-59-layout-regression-fix',
  './auth.js?v=v8-59-layout-regression-fix',
  './workouts.js?v=v8-59-layout-regression-fix',
  './state.js?v=v8-59-layout-regression-fix',
  './account.js?v=v8-59-layout-regression-fix',
  './admin.js?v=v8-59-layout-regression-fix',
  './render.js?v=v8-59-layout-regression-fix',
  './app.js?v=v8-59-layout-regression-fix',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
